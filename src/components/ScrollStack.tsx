...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  const updateCardTransforms = useCallback(() => {
    ...
    const endElement = (
      useWindowScroll
        ? scrollerRef.current?.querySelector('.scroll-stack-end') || document.querySelector('.scroll-stack-end')
  ...
  const setupLenis = useCallback(() => {
    if (useWindowScroll) {
      ...
      const innerContent = scroller.querySelector('.scroll-stack-inner') as HTMLElement | undefined;
